const MySkills = () => {
  return (
    <div className="px-5 p-5 md:px-10  lg:px-20  lg:py-20 pt-10" id="skills">
      <h1
        className="
      text-center my-10 md:my-15 lg:my-20 text-2xl md:text-4xl tracking-wide font-extrabold "
      >
        My Skills
      </h1>
